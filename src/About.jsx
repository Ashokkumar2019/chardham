...
export default function About() {
 ...
 <Container>
  <div className='text-center pb-5'><h1>Welcome to Sewa Samiti – Your Trusted Partner for a Divine Journey</h1>
  <p></p></div>
 
  <Row className='justify-content-between'>
    <Col md={6} sm={12}>
    <h2>Sewa Samiti</h2>
    <p>At <strong>Sewa Samiti</strong>, we understand that a pilgrimage is not just a journey—it’s a sacred quest for peace, reflection, and spiritual fulfillment. Our mission is simple: to ensure that your yatra is a serene and enriching experience, free from the concerns of travel logistics.</p>
    <p>
    ...
    <p>
    Whether you’re visiting ancient temples, exploring serene landscapes, or immersing yourself in moments of quiet reflection, <strong>Sewa Samiti</strong> is here to make your pilgrimage effortless and meaningful. With us, you’ll experience peace of mind, knowing that your journey is in trusted hands.
    </p>
    <p>
    Embark on your yatra with <strong>Sewa Samiti</strong>, and let us take care of the rest. Together, we’ll create a pilgrimage experience that not only enriches your soul but leaves you with memories that last a lifetime.
    </p>
    <h2> key services</h2>
    <ul>
